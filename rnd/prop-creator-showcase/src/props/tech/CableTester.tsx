  ...
  return (
    <group ref={groupRef}>
      ...
      {Array.from({length: 8}).map((_,i) => (
        <mesh key={JSON.stringify(_)} position={[-0.02+(i%4)*0.012, -0.04-Math.floor(i/4)*0.02, 0.022]}><sphereGeometry args={[0.004, 4, 4]} /><meshStandardMaterial color={i%2===0?'#44ff44':'#ff4444'} emissive={i%2===0?'#44ff44':'#ff4444'} emissiveIntensity={1} /></mesh>
      ))}
