    ...
    <group ref={groupRef}>
      ...
      <group ref={dotsRef}>
        {[...Array(64)].map((_,i) => {
          ...
          return (
            <mesh key={i} position={[x*0.024, y*0.024-0.12, 0.012]}><sphereGeometry args={[0.006, 4, 4]} /><meshStandardMaterial color="#ff2222" emissive="#ff2222" emissiveIntensity={0.5} /></mesh>
          );
        })}
      </group>
