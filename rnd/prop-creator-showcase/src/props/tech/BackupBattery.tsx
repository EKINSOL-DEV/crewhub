...
export function BackupBattery() {
  ...
  return (
    <group ref={groupRef}>
      ...
      {[0,1,2,3].map(i => (
        <mesh key={i} position={[-0.02+i*0.02, -0.04, 0.032]}><boxGeometry args={[0.01, 0.02, 0.002]} /><meshStandardMaterial color={i<3?'#44ff44':'#333344'} emissive={i<3?'#44ff44':'#000000'} emissiveIntensity={i<3?1:0} /></mesh>
      ))}
