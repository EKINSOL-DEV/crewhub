...
export function WatercolorSet() {
  ...
  return (
    <group ref={groupRef}>
      ...
      {['#ff4444','#ff8844','#ffcc44','#44cc44','#4488ff','#4444cc','#884488','#aa5533','#222222','#ffffff','#ff88aa','#88ddff'].map((c,i) => (
        <mesh key={`c-${i}`} position={[-0.13+(i%6)*0.053, -0.18, -0.04+Math.floor(i/6)*0.06]}><boxGeometry args={[0.04, 0.01, 0.04]} /><meshStandardMaterial color={c} flatShading /></mesh>
      ))}
