...
export function TrashCan() {
  ...
  return (
    <group ref={groupRef}>
      ...
      <mesh position={[0, 0.12, 0]}><torusGeometry args={[0.2, 0.015, 6, 8]} /><meshStandardMaterial color="#889aaa" flatShading /></mesh>
            <mesh position={[0, 0.16, 0]}>
        <cylinderGeometry args={[0.21, 0.21, 0.03, 8]} />
        <meshStandardMaterial color="#778899" flatShading />
      </mesh>
      <mesh position={[0, 0.2, 0]} rotation={[Math.PI/2, 0, 0]}><torusGeometry args={[0.06, 0.01, 4, 8]} /><meshStandardMaterial color="#99aabb" flatShading /></mesh>
