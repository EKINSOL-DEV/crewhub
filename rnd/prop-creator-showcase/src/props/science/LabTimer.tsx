...
export function LabTimer() {
  ...
  useFrame((s) => {
    ...
    if (displayRef.current) (displayRef.current.material as any).emissiveIntensity = 1 + Math.sin(s.clock.elapsedTime * 2) * 0.5;
  });
  return (
    <group ref={groupRef}>
      ...
      <mesh ref={displayRef} position={[0, -0.145, 0.04]}><boxGeometry args={[0.08, 0.02, 0.002]} /><meshStandardMaterial color="#ff4444" emissive="#ff4444" emissiveIntensity={1.5} /></mesh>
