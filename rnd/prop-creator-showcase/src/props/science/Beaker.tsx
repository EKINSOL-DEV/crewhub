...
export function Beaker() {
  ...
  useFrame((s) => {
    ...
    if (bubbleRef.current) bubbleRef.current.children.forEach((b, i) => {
  ...
  return (
    <group ref={groupRef}>
      ...
      <mesh position={[0, -0.15, 0]}>
        ...
        <meshStandardMaterial color="#ccddee" transparent opacity={0.2} side={THREE.DoubleSide} flatShading />
      </mesh>
      {/* Spout */}
