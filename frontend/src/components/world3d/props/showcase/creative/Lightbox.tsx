...
export function Lightbox() {
  ...
  return (
    <group ref={groupRef}>
      ...
      <mesh position={[0, -0.175, 0]}><boxGeometry args={[0.42, 0.002, 0.32]} /><meshStandardMaterial color="#ffffff" emissive="#ffffff" emissiveIntensity={0.8} transparent opacity={0.7} /></mesh>
