...
export const MONITOR_SCREEN: LibraryComponent = {
  ...
  parts: [
    ...
    },
    {
      ...
      position: [0, 0.25, 0],
      rotation: [0, 0, 0],
      args: [0.12, 0.14, 0.02, 16],
      color: '#444444',
      emissive: false,
    },
    {
      type: 'sphere',
      position: [0.2, 0.36, 0.02],
      rotation: [0, 0, 0],
      args: [0.012, 8, 8],
      color: '#00ff00',
      emissive: true,
  ...
  parts: [
    {
      ...
      position: [0, 0, 0],
      rotation: [0, 0, 0],
      args: [0.12, 0.06, 0.015],
      color: '#333333',
      emissive: false,
    },
    {
      type: 'sphere',
      position: [-0.035, 0, 0.01],
      rotation: [0, 0, 0],
      args: [0.01, 8, 8],
      color: '#00ff00',
      emissive: true,
