...
export function RoomProjectTab({
  room,
  sessions,
  displayNames,
  isActivelyRunning,
        ...
        <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: 'none',
              background: confirmAction === 'clear' ? '#ef4444' : '#3b82f6',
              color: 'white',
              fontSize: 13,
              fontWeight: 600,
              cursor: 'pointer',
        ...
        <>
          ...
          >
            ...
            <div style={{ marginTop: 8 }}>
              {(() => {
                const b = getProjectStatusBadge(currentProject.status)
                return (
                  <span
                    style={{
                      fontSize: 11,
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <button
          onClick={() => onOpenFullBoard?.(projectId, roomId, agents)}
          style={{
            padding: '3px 8px',
            fontSize: 10,
            fontWeight: 600,
