...
export function AdvancedTab() {
  ...
  const { visible: lightingPanelVisible, setVisible: setLightingPanelVisible } =
      ...
      <Section title="🔧 Developer">
        <div className="flex items-center justify-between">
          <Label htmlFor="grid-debug" className="flex flex-col gap-1">
            ...
            <span className="text-xs text-muted-foreground font-normal">
              Show 20×20 grid debug overlay on rooms
            </span>
          </Label>
          <Switch
            id="grid-debug"
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="lighting-editor" className="flex flex-col gap-1">
            ...
            <span className="text-xs text-muted-foreground font-normal">
              Live lighting debug panel with sliders &amp; JSON export
            </span>
          </Label>
          <Switch
            id="lighting-editor"
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="debug-bots" className="flex flex-col gap-1">
            ...
            <span className="text-xs text-muted-foreground font-normal">
              Add fake test bots to rooms for visual testing
            </span>
          </Label>
          <Switch
            id="debug-bots"
