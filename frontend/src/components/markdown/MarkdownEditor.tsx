...
export function MarkdownEditor({ initialContent, onSave, onCancel, onDirtyChange, autoSaveMs = 2500 }: MarkdownEditorProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{
        ...
        {saveStatus === 'saving' && <span style={{ color: 'hsl(var(--primary))' }}>💾 Saving...</span>}
