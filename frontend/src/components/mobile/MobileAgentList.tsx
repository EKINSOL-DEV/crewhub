...
function getStatusInfo(status: AgentStatus): { label: string; dot: string } {
  switch (status) {
    case 'thinking': return { label: 'Thinking…', dot: '#fbbf24' }
    case 'working': return { label: 'Working', dot: '#22c55e' }
    case 'supervising': return { label: 'Supervising', dot: '#8b5cf6' }
    case 'idle': return { label: 'Idle', dot: '#64748b' }
    case 'offline': return { label: 'Offline', dot: '#334155' }
  }
}
