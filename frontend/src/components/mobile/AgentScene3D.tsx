...
function ExpressiveBot({ config, status }: { config: BotVariantConfig; readonly status: AgentStatus }) {
...
export default function AgentScene3D({ botConfig, agentStatus, mini }: Readonly<AgentScene3DProps>) {
