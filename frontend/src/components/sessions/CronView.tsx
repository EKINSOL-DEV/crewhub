...
import { Clock, RefreshCw, Play, Pause, AlertCircle, CheckCircle2, Timer, Zap, Calendar, Repeat } from "lucide-react"
...
function getScheduleIcon(kind: Schedule["kind"]) {
  switch (kind) {
    case "cron": return <Repeat className="h-3 w-3" />
    case "at": return <Calendar className="h-3 w-3" />
    case "every": return <Timer className="h-3 w-3" />
  }
}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          {lastError && status === "error" && (
                            <p
                              className="mt-2 text-xs text-red-500 cursor-help"
                              title={lastError}
                            >
