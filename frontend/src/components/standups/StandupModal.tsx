      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700 }}>
            🗓️ {step === 'done' ? 'Standup Complete!' : step === 'entries' ? `Entry: ${agent?.name}` : 'Start Stand-Up'}
          </h2>
          ...
          <>
            ...
            <input
              ...
              style={{
                ...
                border: '1px solid #e5e7eb', fontSize: 14, marginBottom: 16,
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: selected.size === 0 ? '#d1d5db' : 'linear-gradient(135deg, #4f46e5, #7c3aed)',
                  color: '#fff', fontSize: 13, fontWeight: 600, cursor: selected.size === 0 ? 'not-allowed' : 'pointer',
                }}
              >{submitting ? 'Creating...' : `Start (${selected.size} agents)`}</button>
            </div>
          </>
        )}
          ...
          <>
            ...
            <div style={{ display: 'flex', gap: 4, marginBottom: 16 }}>
              {selectedAgents.map((a, i) => (
                <div key={a.id} style={{
                  ...
                  background: i < currentAgent ? (a.color || '#4f46e5')
                    : i === currentAgent ? '#d1d5db' : '#f3f4f6',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              <span style={{
                ...
                background: agent.color || '#4f46e5', display: 'flex',
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 16 }}>
              ...
              >{submitting ? 'Saving...' : currentAgent < selectedAgents.length - 1 ? 'Next →' : 'Finish ✓'}</button>
            </div>
          </>
        )}
