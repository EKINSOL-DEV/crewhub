...
export function useTasks(options: UseTasksOptions = {}) {
  ...
  const createTask = useCallback(async (task: TaskCreate): Promise<{ success: true; task: Task } | { success: false; error: string }> => {
    try {
  ...
  const getTasksByStatus = useCallback((targetStatus: TaskStatus): Task[] => {
