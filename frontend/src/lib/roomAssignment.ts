...
import { SHARED_ROOM_KEYWORDS } from './roomRoutingShared'
...
export const DEFAULT_ASSIGNMENT_CONFIG: RoomAssignmentConfig = {
  ...
  keywordRules: [
    ...
    },
    {
      ...
      weight: 15,
      keywords: [
        ...SHARED_ROOM_KEYWORDS.marketing,
        'copywriting',
        'search engine',
        'nieuwsbrief',
        'advertentie',
    ...
    },
    {
      ...
      weight: 15,
      keywords: [
        ...SHARED_ROOM_KEYWORDS.automation,
        'cronjob',
        'scheduled',
        'herinnering',
        'timeout',
