...
**Docs:**
- `creative/creator-zone/creator-zone-prompt.md` — AI generation prompt template
...
**Docs:**
- `creative/modding/3d-modding-masterplan.md` — 5-phase modding vision
- `creative/modding/3d-modding-strategy-review.md` — Strategy analysis
- `creative/modding/modding-opus-review.md` — Opus technical review
- `creative/modding/modding-phase1-review.md` — Phase 1 implementation review
...
**Docs:**
- `creative/pixel-avatars/pixel-avatar-masterplan.md` — Concept and art direction
